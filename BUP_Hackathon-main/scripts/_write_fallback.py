content = '''"""Deterministic fallback parser for operator notes.
...
_BATTERY_TERMS = ("battery", "soc", "reserve", "charger", "inverter",
                  "storage", "discharge")
...
'''
open('app/llm/fallback_parser.py', 'w', encoding='utf-8').write(content)
